      ...
      <div className="container mx-auto px-4">
        <div className="grid gap-12 md:grid-cols-2 items-center">
          <div className="text-center md:text-left">
            <div className="inline-flex items-center gap-2 bg-[var(--accent)]/10 text-[var(--accent-dark)] text-xs font-bold px-4 py-2 rounded-full uppercase tracking-wider mb-4">
              ...
              {product.price.bundle && (
                <div className="border-l border-[var(--gray-200)] pl-4">
                  <div className="text-sm text-[var(--gray-500)] font-semibold">
                    2x <strong className="text-[var(--primary)]">{product.price.bundle.label.split("(")[0].trim()}</strong>
                  </div>
                  <div className="text-[0.65rem] text-[var(--gray-400)]">
                    Ahorras ${formatPrice(product.price.normal * 2 - product.price.bundle.price)}
                  </div>
                </div>
              )}
